...
func (p *Page) Navigate(url string) error {
	return p.client.Navigate(p.pageID, url)
}

// NavigateWithLoadedState 导航并等待加载完成
func (p *Page) NavigateWithLoadedState(url string) error {
	return p.client.NavigateWithLoadedState(p.pageID, url)
}

// Reload 刷新页面
func (p *Page) Reload() error {
	return p.client.Reload(p.pageID)
}

// ReloadWithLoadedState 刷新并等待加载完成
func (p *Page) ReloadWithLoadedState() error {
	return p.client.ReloadWithLoadedState(p.pageID)
}
...
func (p *Page) GetTitle() (string, error) {
	return p.client.GetTitle(p.pageID)
}

// GetURL 获取页面 URL
func (p *Page) GetURL() (string, error) {
	return p.client.GetURL(p.pageID)
}

// GetHTML 获取页面 HTML
func (p *Page) GetHTML() (string, error) {
	return p.client.GetHTML(p.pageID)
}
...
func (p *Page) ExpectResponseText(urlOrPredicate, callback string) (string, error) {
	return p.client.ExpectResponseText(p.pageID, urlOrPredicate, callback)
}

// MustInnerText 强制获取内部文本
func (p *Page) MustInnerText(selector string) (string, error) {
	return p.client.MustInnerText(p.pageID, selector)
}

// MustTextContent 强制获取文本内容
func (p *Page) MustTextContent(selector string) (string, error) {
	return p.client.MustTextContent(p.pageID, selector)
}
...
func (p *Page) CloseAll() error {
	return p.client.CloseAll(p.pageID)
}
...
func (p *Page) Screenshot(format string) ([]byte, error) {
	return p.client.Screenshot(p.pageID, format)
}
...
func (p *Page) Exists(selector string) (bool, error) {
	return p.client.ElementExists(p.pageID, selector)
}

// Text 获取元素文本
func (p *Page) Text(selector string) (string, error) {
	return p.client.ElementText(p.pageID, selector)
}

// Click 点击元素
func (p *Page) Click(selector string) error {
	return p.client.ElementClick(p.pageID, selector)
}

// SetValue 设置元素值
func (p *Page) SetValue(selector, value string) error {
	return p.client.ElementSetValue(p.pageID, selector, value)
}

// Attribute 获取元素属性
func (p *Page) Attribute(selector, attr string) (string, error) {
	return p.client.ElementAttribute(p.pageID, selector, attr)
}

// AllTexts 获取所有匹配元素的文本
func (p *Page) AllTexts(selector string) ([]string, error) {
	return p.client.ElementAllTexts(p.pageID, selector)
}

// AllAttributes 获取所有匹配元素的属性
func (p *Page) AllAttributes(selector, attr string) ([]string, error) {
	return p.client.ElementAllAttributes(p.pageID, selector, attr)
}

// Count 获取元素数量
func (p *Page) Count(selector string) (int, error) {
	return p.client.ElementCount(p.pageID, selector)
}
